...
async function fcmListen(options) {
    ...
    console.log("Listening for FCM Notifications r");
    fcmClient = await listen(config.fcm_credentials, ({ notification, persistentId }) => {
        ...
        console.log(body);
        console.log("ID unica "+body.entityId+" tipo "+body.entityName);
        prefs.clear();
        if (body.entityId != undefined || body.entityID != null)  prefs.set(body.entityId,body.entityName);
